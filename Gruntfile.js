module.exports = function(grunt) {
  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'seerai_sphinx_theme/static/fonts/FreightSans',
              filter: 'isFile'
          },

          {
              ...
              dest: 'seerai_sphinx_theme/static/fonts/IBMPlexMono',
              filter: 'isFile'
          }
        ]
      },
        ...
        files: [
          {
              ...
              flatten: true,
              src: ['images/*'],
              dest: 'seerai_sphinx_theme/static/images',
              filter: 'isFile'
          }
        ]
      },
      ...
      vendor: {
        files: [
...

          {
            ...
            dest: 'seerai_sphinx_theme/static/js/vendor',
            filter: 'isFile'
          }
        ]
      }
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'scss',
          src: ['*.scss'],
          dest: 'seerai_sphinx_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    postcss: {
      ...
      dist: {
        files: {
          "seerai_sphinx_theme/static/css/theme.css": "seerai_sphinx_theme/static/css/theme.css"
        }
      }
    },
    ...
    browserify: {
      dev: {
        options: {
          external: ['jquery'],
          alias: {
            'seerai-sphinx-theme': './js/theme.js'
          }
        },
        src: ['js/*.js'],
        dest: 'seerai_sphinx_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    uglify: {
      dist: {
        ...
        files: [{
          expand: true,
          src: ['seerai_sphinx_theme/static/js/*.js', '!seerai_sphinx_theme/static/js/*.min.js'],
          dest: 'seerai_sphinx_theme/static/js/',
    ...
    clean: {
      build: ["docs/build"],
      fonts: ["seerai_sphinx_theme/static/fonts"],
      images: ["seerai_sphinx_theme/static/images"],
      css: ["seerai_sphinx_theme/static/css"],
      js: ["seerai_sphinx_theme/static/js/*", "!seerai_sphinx_theme/static/js/modernizr.min.js"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['seerai_sphinx_theme/**/*', 'README.rst', 'docs/**/*.rst', 'docs/**/*.py'],
